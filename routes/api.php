...
use App\Http\Controllers\Api\PartsListController;
use App\Http\Controllers\Api\BuyerListController;
use App\Http\Controllers\Api\vehiclelistController; // Corrected the controller name
...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::resource('user', UserController::class)->except(['create', 'edit']); // Using resource route for UserController
    Route::get('/profile/show', [ProfileController::class, 'show']); // No need for resource route for ProfileController since only show route is defined

    Route::resource('vehicle', VehicleListController::class)->except(['create', 'edit']); // Using resource route for VehicleListController
    Route::resource('parts', PartsListController::class)->except(['create', 'edit']); // Using resource route for PartsListController
    Route::resource('buyer', BuyerListController::class)->except(['create', 'edit']); // Using resource route for BuyerListController
});
